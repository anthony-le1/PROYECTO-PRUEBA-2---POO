    ...
    public Licencia emitirLicencia(Long conductorId, String tipoLicencia, Long pruebaPsicometricaId)
        ...
        try {
            ...
            if (pruebaPsicometricaId == null) {
                throw new DocumentoInvalidoException(
                        "No se puede emitir licencia: el conductor no tiene una prueba psicométrica aprobada"
                );
            }
            ...
            if (!prueba.estaAprobado()) {
                throw new DocumentoInvalidoException(
                        "No se puede emitir licencia: prueba psicométrica no aprobada"
                );
            }


            // 4. Verificar que no tenga licencias vigentes del mismo tipo
            if (licenciaDAO.existeLicenciaVigentePorTipo(conductorId, tipoLicencia)) {
                throw new DocumentoInvalidoException(
